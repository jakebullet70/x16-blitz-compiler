...
Bank 4 is full. Taken from `source/drive/XBASE.MAP` paired with `source/drive/XBASE.SRC.SYM`, by
...
- Nothing propagates to `GPC-BASIC/` or `GPC-BASIC-TOOLS-SRC/GPB-MODS-TESTING/GPC-BASIC/` until
