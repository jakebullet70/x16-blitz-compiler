...
- **BASL MODULES**
  ...
  - [4.21 GPBMODS -- the harness that drives every module (2)](#421-gpbmods----the-harness-that-drives-every-module-2)
...
*See also: 4.2 STRINGS.INC.BL -- string helpers*
...
## 4.21 GPBMODS -- the harness that drives every module (2)
