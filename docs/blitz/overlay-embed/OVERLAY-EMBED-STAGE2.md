...
`source/scratch/banktest3/BNKBIG.BASL` is new — a generated program with 100 one-page
...
`source/scratch/banktest3/BNKBIG.BASL` is already in place and tokenises clean.
