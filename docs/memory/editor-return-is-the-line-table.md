...
**Measured old against new in ONE program on ONE fixture** (`samples/edit/bench/SLOTBEN.BASL`, which
...
file it meets. `samples/edit/bench/SLOTTST.BASL` is the guard: 2,100 entries, **every slot checked, not
