...
**Measured old against new in ONE program on ONE fixture** (`GPC-BASIC-TOOLS-SRC/edit/bench/SLOTBEN.BASL`, which
...
file it meets. `GPC-BASIC-TOOLS-SRC/edit/bench/SLOTTST.BASL` is the guard: 2,100 entries, **every slot checked, not
