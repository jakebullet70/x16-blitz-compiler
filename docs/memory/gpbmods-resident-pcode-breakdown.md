...
`GPC-BASIC-TOOLS-SRC/GPB-MODS-TESTING/readme.md` carries the current ones.

**Measured 2026-09-06** from `source/drive/GPBMODS.MAP` + `GPBMODS.SRC.SYM`, charging each label the
