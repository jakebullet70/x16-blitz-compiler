...
in `samples/GPB-MODS-TESTING/readme.md`. They belong in the help system, under
...
`#INCLUDE`. The per-module p-code table is in `samples/GPB-MODS-TESTING/readme.md` under *Where the
