...
description: samples/edit/ED-STORE 255.BASL is editor test data, not source - never flag it as dead code
metadata:
  type: project
---

`samples/edit/ED-STORE 255.BASL` is a **test document loaded in the editor**, not a
...
`samples/edit/` dead, ask whether it is something the editor *opens* rather than
