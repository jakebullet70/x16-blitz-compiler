...
;
RT_ABI = 17 								; runtime ABI ordinal -> "GP17" magic (NOT the file name)
...
PCD_GPCMD_BOX        = $d784 ; gp.box
PCD_GPCMD_FILL       = $d785 ; gp.fill
PCD_GPCMD_PRINTAT    = $d786 ; gp.printat
PCD_GPCMD_MENU       = $d787 ; gp.menu
PCD_GPCMD_SEL        = $d788 ; gp.sel
PCD_GPCMD_SORT       = $d789 ; gp.sort
PCD_GPCMD_ARRPTR     = $d78a ; gp.arrptr
PCD_GPCMD_STASH      = $d78b ; gp.stash
PCD_GPCMD_RESTR      = $d78c ; gp.restr
PCD_GPCMD_COMP       = $d78d ; gp.comp
PCD_GPCMD_UPPER      = $d78e ; gp.upper
PCD_GPCMD_LOWER      = $d78f ; gp.lower
PCD_GPCMD_TRIM       = $d790 ; gp.trim
PCD_GPCMD_RTRIM      = $d791 ; gp.rtrim
PCD_GPCMD_LTRIM      = $d792 ; gp.ltrim
PCD_JOY              = $d793 ; joy
PCD_INT              = $d794 ; int
PCD_SQR              = $d795 ; sqr
PCD_LOG              = $d796 ; log
...
PCD_TAN              = $d79a ; tan
PCD_ATN              = $d79b ; atn
PCD_LINPUT           = $d79c ; linput
PCD_BINPUT           = $d79d ; binput
PCD_LOAD             = $d79e ; load
PCD_BLOAD            = $d79f ; bload
PCD_BVLOAD           = $d7a0 ; bvload
PCD_VLOAD            = $d7a1 ; vload
PCD_BSAVE            = $d7a2 ; bsave
PCD_BVERIFY          = $d7a3 ; bverify
PCD_POWEROFF         = $d7a4 ; poweroff
PCD_RESET            = $d7a5 ; reset
PCD_REBOOT           = $d7a6 ; reboot
PCD_MOUSE            = $d7a7 ; mouse
PCD_MB               = $d7a8 ; mb
PCD_MX               = $d7a9 ; mx
PCD_MY               = $d7aa ; my
PCD_MWHEEL           = $d7ab ; mwheel
PCD_RPTDOLLAR        = $d7ac ; rpt$
PCD_SPRITE           = $d7ad ; sprite
PCD_SPRMEM           = $d7ae ; sprmem
PCD_MOVSPR           = $d7af ; movspr
PCD_ST               = $d7b0 ; st
PCD_STOP             = $d7b1 ; stop
PCD_SYS              = $d7b2 ; sys
PCD_TDATA            = $d7b3 ; tdata
PCD_TATTR            = $d7b4 ; tattr
PCD_TILE             = $d7b5 ; tile
PCD_TICMD_WRITE      = $d7b6 ; ti.write
PCD_TIDOLLARCMD_WRITE = $d7b7 ; ti$.write
PCD_WAIT             = $d7b8 ; wait
PCD_I2CPOKE          = $d7b9 ; i2cpoke
PCD_I2CPEEK          = $d7ba ; i2cpeek
PCD_BANK             = $d7bb ; bank
PCD_SLEEP            = $d7bc ; sleep
PCD_FMINIT           = $d7bd ; fminit
PCD_FMNOTE           = $d7be ; fmnote
PCD_FMDRUM           = $d7bf ; fmdrum
PCD_FMINST           = $d7c0 ; fminst
PCD_FMVIB            = $d7c1 ; fmvib
PCD_FMFREQ           = $d7c2 ; fmfreq
PCD_FMVOL            = $d7c3 ; fmvol
PCD_FMPAN            = $d7c4 ; fmpan
PCD_FMPLAY           = $d7c5 ; fmplay
PCD_FMCHORD          = $d7c6 ; fmchord
PCD_FMPOKE           = $d7c7 ; fmpoke
PCD_PSGINIT          = $d7c8 ; psginit
PCD_PSGNOTE          = $d7c9 ; psgnote
PCD_PSGVOL           = $d7ca ; psgvol
PCD_PSGWAV           = $d7cb ; psgwav
PCD_PSGFREQ          = $d7cc ; psgfreq
PCD_PSGPAN           = $d7cd ; psgpan
PCD_PSGPLAY          = $d7ce ; psgplay
PCD_PSGCHORD         = $d7cf ; psgchord
PCD_CLS              = $d7d0 ; cls
PCD_LOCATE           = $d7d1 ; locate
PCD_COLOR            = $d7d2 ; color
; ************************************************************************************************
; ************************************************************************************************
;
