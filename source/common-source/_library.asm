...
PCD_STOP             = $ce91 ; stop
PCD_SYS              = $ce92 ; sys
PCD_TICMD_WRITE      = $ce93 ; ti.write
PCD_TIDOLLARCMD_WRITE = $ce94 ; ti$.write
PCD_WAIT             = $ce95 ; wait
PCD_I2CPOKE          = $ce96 ; i2cpoke
PCD_POWEROFF         = $ce97 ; poweroff
PCD_REBOOT           = $ce98 ; reboot
PCD_I2CPEEK          = $ce99 ; i2cpeek
PCD_BANK             = $ce9a ; bank
PCD_SLEEP            = $ce9b ; sleep
PCD_FMINIT           = $ce9c ; fminit
PCD_FMNOTE           = $ce9d ; fmnote
PCD_FMDRUM           = $ce9e ; fmdrum
PCD_FMINST           = $ce9f ; fminst
PCD_FMVIB            = $cea0 ; fmvib
PCD_FMFREQ           = $cea1 ; fmfreq
PCD_FMVOL            = $cea2 ; fmvol
PCD_FMPAN            = $cea3 ; fmpan
PCD_FMPLAY           = $cea4 ; fmplay
PCD_FMCHORD          = $cea5 ; fmchord
PCD_FMPOKE           = $cea6 ; fmpoke
PCD_PSGINIT          = $cea7 ; psginit
PCD_PSGNOTE          = $cea8 ; psgnote
PCD_PSGVOL           = $cea9 ; psgvol
PCD_PSGWAV           = $ceaa ; psgwav
PCD_PSGFREQ          = $ceab ; psgfreq
PCD_PSGPAN           = $ceac ; psgpan
PCD_PSGPLAY          = $cead ; psgplay
PCD_PSGCHORD         = $ceae ; psgchord
PCD_CLS              = $ceaf ; cls
PCD_LOCATE           = $ceb0 ; locate
PCD_COLOR            = $ceb1 ; color
; ************************************************************************************************
; ************************************************************************************************
;
