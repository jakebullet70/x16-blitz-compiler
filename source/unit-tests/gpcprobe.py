...
#   source/application/GPC.BIN. The inputs come from INPUTS, source/scratch/dcref/inputs/ by default, and
#   the compile runs in DRIVE, source/scratch/gpcprobe/NAME/ by default.
#
...
#   source/scratch/gpctest/ref/off/NAME/.
#
...
drive = os.path.abspath(sys.argv[3]) if len(sys.argv) > 3 else os.path.join(dcref.ROOT, "source", "scratch", "gpcprobe", NAME)
