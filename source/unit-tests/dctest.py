...
#   compiled with GPC.INPUT line 5 set, in a drive of its own under source/scratch/dctest/. The compile
#   writes the removed-line list D.NAME, and the OK line is followed by
#   DEAD CODE: <lines> LINES REMOVED, <bytes> BYTES SAVED.
#
#   The runtime images come from source/scratch/dcref/inputs/, the fixed copy dcref.py keeps.
...
WORK = os.path.join(ROOT, "source", "scratch", "dctest")
INPUTS = os.path.join(ROOT, "source", "scratch", "dcref", "inputs")
