...
#			source/drive/GPC.BIN   the compiler engine      (make libs)
#			source/drive/GPC.RT.nnn.BIN  the resident runtime      (make -C source/runtime gpc-rt)
#
...
from rtname import rc_filename                                          # noqa: E402

RT_NAME  = rc_filename()
RT_MAGIC = b"GP%02d" % RT_ABI          # "GP" + TWO digits: 4 bytes, room to ABI 99

# Files this test creates in source/drive/ (the emulator's drive). All prefixed RT_ and cleaned up.
SRC_BAS   = "RT_SRC.BAS"
SRC_PRG   = "RT_SRC.PRG"
OBJ_PRG   = "RT_OBJ.PRG"
